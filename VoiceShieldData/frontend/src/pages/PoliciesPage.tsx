  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8 cyber-grid-bg">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-200 pb-6">
        ...
        <button
          onClick={handleSave}
          className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#3B82F6] to-[#3B82F6] hover:from-[#2563EB] hover:to-[#2563EB] text-white font-semibold font-sans text-xs flex items-center gap-2 shadow-[0_0_20px_rgba(6,182,212,0.25)] transition-all hover:scale-[1.02]"
        >
      ...
      {saved && (
        <div className="p-4 rounded-2xl bg-[rgba(16,185,129,0.1)] border border-[rgba(16,185,129,0.3)] text-[#10B981] text-xs flex items-center gap-2 animate-fade-in font-sans shadow-[0_0_15px_rgba(16,185,129,0.15)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="glass-card p-6 border-[rgba(16,185,129,0.3)] space-y-4 bg-gradient-to-b from-[rgba(16,185,129,0.08)] via-[#0B1628] to-[#0B1628]">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-sans font-bold px-3 py-1 rounded-full bg-[rgba(16,185,129,0.15)] border border-[rgba(16,185,129,0.35)] text-[#10B981]">
              ALLOW
            </span>
          </div>

          <div>
            <h3 className="text-base font-bold text-gray-900 font-sans">Low Risk Calls</h3>
            <p className="text-xs text-gray-600 font-sans">Risk Score &lt; <span className="font-mono font-medium">{reviewThreshold}%</span></p>
          </div>
          ...
          <div className="pt-3 border-t border-gray-200 text-[11px] font-sans text-[#10B981] font-semibold flex items-center gap-1.5">
            <span>•</span> Automated Direct Connect
          </div>
        </div>
        ...
        <div className="glass-card p-6 border-[rgba(245,158,11,0.3)] space-y-4 bg-gradient-to-b from-[rgba(245,158,11,0.08)] via-[#0B1628] to-[#0B1628]">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-sans font-bold px-3 py-1 rounded-full bg-[rgba(245,158,11,0.15)] border border-[rgba(245,158,11,0.35)] text-[#F59E0B]">
              REVIEW
            </span>
          </div>

          <div>
            <h3 className="text-base font-bold text-gray-900 font-sans">Suspicious Calls</h3>
            <p className="text-xs text-gray-600 font-sans">Risk Score between <span className="font-mono font-medium">{reviewThreshold}% – {blockThreshold}%</span></p>
          </div>
          ...
          <div className="pt-3 border-t border-gray-200 text-[11px] font-sans text-[#F59E0B] font-semibold flex items-center gap-1.5">
            <span>•</span> Screen-Pop Agent Alert & Liveness Check
          </div>
        </div>
        ...
        <div className="glass-card p-6 border-[rgba(239,68,68,0.3)] space-y-4 bg-gradient-to-b from-[rgba(239,68,68,0.08)] via-[#0B1628] to-[#0B1628]">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-sans font-bold px-3 py-1 rounded-full bg-[rgba(239,68,68,0.15)] border border-[rgba(239,68,68,0.35)] text-[#EF4444]">
              BLOCK
            </span>
          </div>

          <div>
            <h3 className="text-base font-bold text-gray-900 font-sans">Critical Deepfakes</h3>
            <p className="text-xs text-gray-600 font-sans">Risk Score &gt; <span className="font-mono font-medium">{blockThreshold}%</span></p>
          </div>
          ...
          <div className="pt-3 border-t border-gray-200 text-[11px] font-sans text-[#EF4444] font-semibold flex items-center gap-1.5">
            <span>•</span> Automated SIP Drop / Intercept Trap
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between text-xs font-sans">
              ...
              <span className="text-[#F59E0B] font-bold font-mono text-sm">{reviewThreshold}%</span>
            </div>
            <input
              type="range"
              min="20"
            ...
            />
            <p className="text-[11px] text-[#64748B] font-sans">Calls above this threshold require secondary verification.</p>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between text-xs font-sans">
              ...
              <span className="text-[#EF4444] font-bold font-mono text-sm">{blockThreshold}%</span>
            </div>
            <input
              type="range"
              min="60"
            ...
            />
            <p className="text-[11px] text-[#64748B] font-sans">Calls above this threshold are terminated immediately.</p>
          </div>
        </div>
      </div>
    </div>
