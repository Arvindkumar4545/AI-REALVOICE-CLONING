      ...
      <div className="max-w-md w-full glass-panel p-8 sm:p-10 rounded-3xl border border-gray-200 space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 font-sans">
          ...
          <div className="space-y-1">
            <label className="text-xs font-sans text-gray-600 font-semibold block">Full Name</label>
          ...
          <div className="space-y-1">
            <label className="text-xs font-sans text-gray-600 font-semibold block">Enterprise Email</label>
            <div className="relative">
          ...
          <div className="space-y-1">
            <label className="text-xs font-sans text-gray-600 font-semibold block">Password</label>
            <div className="relative">
          ...
          <div className="space-y-1">
            <label className="text-xs font-sans text-gray-600 font-semibold block">Confirm Password</label>
            <div className="relative">
              <Lock className="w-4 h-4 text-[#64748B] absolute left-3 top-1/2 -translate-y-1/2" />
              <input
                type="password"
