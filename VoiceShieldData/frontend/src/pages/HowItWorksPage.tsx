...
export const HowItWorksPage: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16 cyber-grid-bg">
      {/* Header */}
      <div className="text-center space-y-3 max-w-3xl mx-auto font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-sans">
        <div className="glass-card p-6 space-y-3">
          ...
          <h4 className="text-base font-bold text-gray-900 font-sans">1. Continuous Windowing</h4>
        ...
        <div className="glass-card p-6 space-y-3">
          ...
          <h4 className="text-base font-bold text-gray-900 font-sans">2. Neural Multi-Model Ensemble</h4>
          <p className="text-xs text-gray-600 leading-relaxed font-sans">
        ...
        <div className="glass-card p-6 space-y-3">
          ...
          <h4 className="text-base font-bold text-gray-900 font-sans">3. Calibrated Risk Stacking</h4>
          <p className="text-xs text-gray-600 leading-relaxed font-sans">
      ...
      {/* CTA Box */}
      <div className="glass-panel p-8 rounded-3xl border border-gray-200 flex flex-col md:flex-row items-center justify-between gap-6 bg-gradient-to-r from-[#3B82F6]/10 via-[#0B1628] to-[#3B82F6]/10 font-sans">
        <div className="space-y-1">
          <h3 className="text-lg font-bold text-gray-900 font-sans">Experience the forensic engine firsthand</h3>
          <p className="text-xs text-gray-600 font-sans">Test sample voice files or live mic speech in the Voice Inspector workspace.</p>
        </div>
        <Link
          to="/detect"
          className="px-6 py-3 rounded-xl bg-gradient-to-r from-[#3B82F6] to-[#3B82F6] text-white font-semibold font-sans text-xs shadow-[0_0_30px_rgba(6,182,212,0.25)] inline-flex items-center gap-2 flex-shrink-0 hover:scale-[1.02] transition-all"
        >
