  ...
  return (
    <div className="min-h-screen pt-10 pb-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 cyber-grid-bg">
      <div className="border-b border-[#16324A] pb-6 space-y-1">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[rgba(16,185,129,0.08)] border border-[rgba(16,185,129,0.30)] text-xs font-sans text-[#10B981] font-semibold">
          <Lock className="w-3.5 h-3.5 text-[#10B981]" />
          <span>Data Sovereignty & Privacy Center</span>
        </div>
        <h1 className="text-2xl sm:text-3xl font-extrabold text-[#F8FAFC] tracking-tight font-sans">
      ...
      <div className="glass-panel p-8 rounded-3xl border border-[#16324A] space-y-6 font-sans">
        <div className="space-y-3">
          <h3 className="text-lg font-bold text-[#F8FAFC] font-sans tracking-tight">1. Ephemeral Voice Ingestion</h3>
        ...
        <div className="space-y-3 pt-4 border-t border-[#16324A]">
          <h3 className="text-lg font-bold text-[#F8FAFC] font-sans tracking-tight">2. Regulatory Compliance</h3>
          <p className="text-xs text-[#94A3B8] leading-relaxed font-sans">
        ...
        <div className="space-y-3 pt-4 border-t border-[#16324A]">
          <h3 className="text-lg font-bold text-[#F8FAFC] font-sans tracking-tight">3. Cryptographic Audit Telemetry</h3>
          <p className="text-xs text-[#94A3B8] leading-relaxed font-sans">
