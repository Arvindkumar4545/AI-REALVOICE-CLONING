    ...
    <div className="w-full space-y-24 pb-20 cyber-grid-bg">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center pt-8 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-gray-100 border border-gray-300 text-xs font-sans text-gray-900 font-semibold">
              <Sparkles className="w-3.5 h-3.5 text-gray-900" />
              <span>About VoiceShield AI Operations</span>
            </div>
            <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 tracking-tight leading-tight font-sans">
              TRUST EVERY <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-800 via-gray-700 to-gray-900">
                VOICE INTERACTION.
              </span>
            </h1>
            <p className="text-base text-gray-600 max-w-xl leading-relaxed font-normal font-sans">
            ...
            <div className="pt-2">
              <Link
                to="/detect"
                className="px-6 py-3 rounded-xl bg-gradient-to-r from-gray-800 to-gray-900 hover:from-gray-900 hover:to-black text-white font-semibold font-sans text-xs inline-flex items-center gap-2 shadow-md transition-all"
              >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="glass-panel p-8 sm:p-12 rounded-3xl border border-gray-200 space-y-6">
          <div className="max-w-3xl space-y-4">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 font-sans tracking-tight">What is VoiceShield AI?</h2>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="text-center space-y-2 max-w-2xl mx-auto">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[rgba(239,68,68,0.1)] border border-[rgba(239,68,68,0.3)] text-[11px] font-sans text-[#EF4444] font-semibold">
            <AlertTriangle className="w-3.5 h-3.5 text-[#EF4444]" />
            <span>The Threat Landscape</span>
          </div>
          <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 font-sans tracking-tight">The Rising Crisis in Voice Security</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="glass-card p-6 space-y-2">
            <div className="text-xs font-sans font-bold text-[#EF4444] uppercase tracking-wide">01. AI Voice Cloning</div>
            <h4 className="text-base font-bold text-gray-900 font-sans">Zero-Shot Synthesis</h4>
          ...
          <div className="glass-card p-6 space-y-2">
            <div className="text-xs font-sans font-bold text-[#EF4444] uppercase tracking-wide">02. Deepfake Calls Real-Time Conversational Bots</div>
            <h4 className="text-base font-bold text-gray-900 font-sans">AI Impersonation Attacks</h4>
            <p className="text-xs text-gray-600 leading-relaxed font-sans">
          ...
          <div className="glass-card p-6 space-y-2">
            <div className="text-xs font-sans font-bold text-[#EF4444] uppercase tracking-wide">03. Social Engineering</div>
            <h4 className="text-base font-bold text-gray-900 font-sans">Real-Time Conversational Bots</h4>
            <p className="text-xs text-gray-600 leading-relaxed font-sans">
          ...
          <div className="glass-card p-6 space-y-2">
            <div className="text-xs font-sans font-bold text-[#EF4444] uppercase tracking-wide">03. Social Engineering</div>
            <h4 className="text-base font-bold text-gray-900 font-sans">Executive Impersonation (CEO Fraud)</h4>
            <p className="text-xs text-gray-600 leading-relaxed font-sans">
          ...
          <div className="glass-card p-6 space-y-2">
            <div className="text-xs font-sans font-bold text-[#EF4444] uppercase tracking-wide">04. Synthetic Speech</div>
            <h4 className="text-base font-bold text-gray-900 font-sans">Neural Vocoder Artifacts</h4>
            <p className="text-xs text-gray-600 leading-relaxed font-sans">
          ...
          <div className="glass-card p-6 space-y-2">
            <div className="text-xs font-sans font-bold text-[#EF4444] uppercase tracking-wide">05. Caller Spoofing</div>
            <h4 className="text-base font-bold text-gray-900 font-sans">Telco ID Manipulation</h4>
            <p className="text-xs text-gray-600 leading-relaxed font-sans">
          ...
          <div className="glass-card p-6 space-y-2">
            <div className="text-xs font-sans font-bold text-[#EF4444] uppercase tracking-wide">06. Financial Fraud</div>
            <h4 className="text-base font-bold text-gray-900 font-sans">KYC & Biometric Bypass</h4>
            <p className="text-xs text-gray-600 leading-relaxed font-sans">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="text-center space-y-2 max-w-2xl mx-auto">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white border border-gray-200 text-[11px] font-sans text-gray-900 font-semibold">
            <Cpu className="w-3.5 h-3.5 text-gray-900" />
            <span>Interactive 3D Pipeline</span>
          </div>
          <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 font-sans tracking-tight">How VoiceShield AI Works</h2>
          <p className="text-xs sm:text-sm text-gray-600 font-sans">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="text-center space-y-2 max-w-2xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 font-sans tracking-tight">Why VoiceShield AI?</h2>
          <p className="text-xs sm:text-sm text-gray-600 font-sans">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            <div key={pillar.num} className="glass-card p-5 space-y-2">
              <span className="text-xs font-sans font-bold text-gray-900">{pillar.num}.</span>
              <h4 className="text-sm font-bold text-gray-900 font-sans">{pillar.title}</h4>
              <p className="text-xs text-gray-600 leading-relaxed font-sans">{pillar.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="text-center space-y-2 max-w-2xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 font-sans tracking-tight">Built for High-Stakes Operations</h2>
          <p className="text-xs sm:text-sm text-gray-600 font-sans">
          ...
          {[
            ...
            return (
              <div key={idx} className="glass-card p-6 flex flex-col items-center justify-center text-center space-y-3 glass-card-hover">
                ...
                <span className="text-xs font-bold text-gray-900 font-sans">{item.name}</span>
              </div>
            );
          })}
        </div>
