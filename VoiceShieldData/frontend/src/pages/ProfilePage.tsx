    ...
    <div className="min-h-screen pt-10 pb-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 cyber-grid-bg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-sans">
        ...
        <div className="glass-panel p-6 rounded-3xl border border-gray-200 text-center space-y-4 md:col-span-1">
          ...
          <div>
            <h3 className="text-lg font-bold text-gray-900 font-sans">{user?.full_name || 'Security Analyst'}</h3>
            <p className="text-xs text-gray-700 font-sans font-medium">{user?.role || 'SOC_ANALYST_L2'}</p>
          </div>
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[rgba(16,185,129,0.08)] border border-[rgba(16,185,129,0.30)] text-[10px] font-sans text-[#10B981] font-semibold">
        ...
        {/* Details Card */}
        <div className="glass-panel p-6 rounded-3xl border border-gray-200 space-y-4 md:col-span-2 font-sans">
          <h4 className="text-sm font-bold text-gray-900 font-sans tracking-tight border-b border-gray-200 pb-3">
          ...
          <div className="space-y-3 text-xs font-sans">
            <div className="flex items-center justify-between p-3 rounded-xl bg-gray-50 border border-gray-200">
              ...
              <span className="text-gray-900 font-medium">{user?.email || 'analyst@enterprise.com'}</span>
            </div>
            ...
            <div className="flex items-center justify-between p-3 rounded-xl bg-gray-50 border border-gray-200">
              ...
              <span className="text-gray-900 font-medium">VoiceShield SOC Primary Node</span>
            </div>
            ...
            <div className="flex items-center justify-between p-3 rounded-xl bg-gray-50 border border-gray-200">
              ...
              <span className="text-gray-900 font-mono font-semibold">VS-KEY-88192-ECDSA</span>
            </div>
            ...
            <div className="flex items-center justify-between p-3 rounded-xl bg-gray-50 border border-gray-200">
              ...
              <span className="text-gray-900 font-medium">Active (Auto-Refreshed via JWT)</span>
            </div>
          </div>
        </div>
      </div>
