...
CLASS_BONAFIDE: str = "GENUINE_HUMAN"
CLASS_SPOOF: str = "AI_GENERATED_TTS"
CLASS_CLONE: str = "VOICE_CLONE"
CLASS_REPLAY: str = "REPLAY_ATTACK"
CLASS_MANIPULATED: str = "AUDIO_MANIPULATION"
